...
async def run_test():
    ...
    try:
        ...
        # --> The dashboard summary is displayed (Dashboard page with summary and folder table is visible).
        await page.locator("xpath=/html/body/div[2]/main/div/div[2]/div[2]/div/table/thead/tr").nth(0).scroll_into_view_if_needed()
        # Assert-outcome: passed
        # Assert: The dashboard's folder summary table header is visible.
        await expect(page.locator("xpath=/html/body/div[2]/main/div/div[2]/div[2]/div/table/thead/tr").nth(0)).to_be_visible(timeout=15000), "The dashboard's folder summary table header is visible."
